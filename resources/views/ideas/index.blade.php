        ...
        <div class="inner-wrapper">
            ...
            <div class="inner-main">
                ...
                <div>
                        ...
                        <a style="white-space: pre-line" href="{{ route('idea.latest') }}">Latest ideas</a> <br>
                        <a style="white-space: pre-line" href="{{ route('idea.mostComment') }}">Most comments</a> <br>
                        <a style="white-space: pre-line" href="{{ route('idea.mostViewed') }}">Most viewed ideas</a>
